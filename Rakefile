...
RCONF = YAML.load_file("_rsync.yml")

LOCAL_PATH = RCONF['local_path']
REMOTE_PATH = RCONF['remote_path']
SSH_USER = RCONF['ssh_user']
SSH_HOST = RCONF['ssh_host']
SYNC_CMD = RCONF['rsync_cmd']
